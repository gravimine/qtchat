...
void AChat::post(QString text, int Typ)
{
...
void AChat::WriteServerList(RecursionArray reply)
{
...
QString AChat::OnlinetoHTML(RecursionArray Map)
{
	QString HTML;
...
void AChat::SMStoValues(RecursionArray Map,bool isClear)
{
