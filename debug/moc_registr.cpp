...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_registr_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 55, 23) // "on_pushButton_3_clicked"
    ...
    "registr\0on_pushButton_2_clicked\0\0"
...
void registr::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        registr *_t = static_cast<registr *>(_o);
        switch (_id) {
...
const QMetaObject registr::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_registr.data,
      qt_meta_data_registr,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *registr::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_registr.stringdata))
        return static_cast<void*>(const_cast< registr*>(this));
